...
def get_simulator_diagnostic() -> dict:
    ...
    return {
        ...
        "adapter": "SIMULATOR_MODBUS_D700_D763_V1",
        "logical_register_range": "D700-D763",
        "socket_opened": False,
        "modbus_offset_applied": False,
        "byte_order_for_test_only": "HIGH_LOW",
        "capabilities": [
            "D700-D749 em memória com escrita em duas fases",
            "D750-D763 em memória com decode pelo codec real",
        ...
        "pending_commissioning": ["ASCII_BYTE_ORDER_AB12", "MODBUS_REGISTER_OFFSET", "LADDER_REVISION"],
        "pending_automation": ["AP_MACHINE_STATE_TABLE", "AP_ACTIVE_FAULT_CODE_TABLE", "AP_RECIPE_ID_TABLE"],
        "message": "Simulador completo do mapa lógico D700-D763 preparado offline; nenhuma conexão com a máquina real é aberta nesta etapa.",
    }
